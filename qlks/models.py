...
if __name__ == "__main__":
    ...
    # db.session.add(rd4)
    #
    # r1 = Room(id=101, image="#1", detail_id=1, rented=0, booked=1, floor=1)
    # r2 = Room(id=102, image="#2", detail_id=1, rented=0, booked=0, floor=1)
    # r3 = Room(id=103, image="#3", detail_id=2, rented=0, booked=0, floor=1)
    # r4 = Room(id=104, image="#4", detail_id=2, rented=0, booked=0, floor=1)
    # r5 = Room(id=105, image="#5", detail_id=3, rented=0, booked=0, floor=1)
    # r6 = Room(id=106, image="#6", detail_id=4, rented=0, booked=0, floor=1)
    # r7 = Room(id=201, image="#7", detail_id=1, rented=0, booked=0, floor=2)
    # r8 = Room(id=202, image="#8", detail_id=1, rented=0, booked=0, floor=2)
    # r9 = Room(id=203, image="#9", detail_id=2, rented=0, booked=0, floor=2)
    # r10 = Room(id=204, image="#10", detail_id=2, rented=1, booked=0, floor=2)
    # r11 = Room(id=205, image="#11", detail_id=3, rented=1, booked=0, floor=2)
    # r12 = Room(id=206, image="#12", detail_id=4, rented=0, booked=0, floor=2)
    # r13 = Room(id=301, image="#13", detail_id=1, rented=0, booked=0, floor=3)
    # r14 = Room(id=302, image="#14", detail_id=1, rented=0, booked=0, floor=3)
    # r15 = Room(id=303, image="#15", detail_id=2, rented=0, booked=0, floor=3)
    # r16 = Room(id=304, image="#16", detail_id=2, rented=0, booked=0, floor=3)
    # r17 = Room(id=305, image="#17", detail_id=3, rented=0, booked=0, floor=3)
    # r18 = Room(id=306, image="#18", detail_id=4, rented=0, booked=1, floor=3)
    #
    # db.session.add(r1)
    # db.session.add(r2)
    # db.session.add(r3)
    ...
    # db.session.add(r18)
    #
    # bi1 = BookInfo(id=1, room_id=101, date_book=25 / 12 / 2021, date_rent=1 / 1 / 2022, date_end=10 / 1 / 2022,
    #                number_of_people=2, foreign=0, customer_id=1, customer_name="Thành")
    # bi2 = BookInfo(id=2, room_id=306, date_book=30 /12 / 2021, date_rent=8 / 1 / 2022, date_end=13 / 1 / 2022,
    #                number_of_people=3, foreign=0, customer_id=2, customer_name="Ngọc")
    #
    # db.session.add(bi1)
    # db.session.add(bi2)
    #
    # ri1 = RentInfo(id=1, room_id=204, date_rent=3 / 1 / 2022, date_end=13 / 1 / 2022,
    #                number_of_people=2, foreign=1, customer_id=1, customer_name="Thomas")
    # ri2 = RentInfo(id=2, room_id=206, date_rent=30 / 12 / 2022,
    #                number_of_people=2, foreign=0, customer_id=2, customer_name="Hằng")
    #
    # db.session.add(ri1)
    # db.session.add(ri2)
